		...
		<div class="container">
			...
			<div class="nav-collapse">
				<ul class="nav">
					...
					<c:choose>
						<c:when test="${ portfoliosNavi == 'true' }">
							<li class="active"><a href="/spicy/portfolios">ポトフォリオ</a></li>
						</c:when>
						<c:otherwise>
							<li><a href="/spicy/portfolios">ポトフォリオ</a></li>
						</c:otherwise>
					</c:choose>
					<c:choose>
						<c:when test="${ jaejungNavi == 'true' }">
							<li class="active"><a href="/spicy/jaejung">ジェジュン</a></li>
						</c:when>
						<c:otherwise>
							<li><a href="/spicy/jaejung">ジェジュン</a></li>
						</c:otherwise>
					</c:choose>
					<c:choose>
						<c:when test="${ dahoonNavi == 'true' }">
							<li class="active"><a href="/spicy/dahoon">ダフン</a></li>
						</c:when>
						<c:otherwise>
							<li><a href="/spicy/dahoon">ダフン</a></li>
						</c:otherwise>
					</c:choose>
					<c:choose>
				...
				<a class="btn btn-danger pull-right"
					href="http://twitter.github.com/bootstrap/">Spicy Soft</a>
			</div>
		</div>
	</div>
</div>