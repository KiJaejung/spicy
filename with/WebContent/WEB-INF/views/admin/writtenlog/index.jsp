...
<script type="text/javascript" src="/with/js/admin/writtenlog_drawing.js"></script>
		...
		<div class="container-fluid">
			<div class="row-fluid">
				...
				<div class="span9">
					...
					<legend><img src="/with/img/admin/statistics.png" style="margin-bottom:5px;" width="25px" height="25px"></img>&nbsp;&nbsp;WrittenLog Statistics</legend>
					<form name="writtenlogform" method="POST">
					
						<select name="period">
							<option value = "0">Period Select</option>
					...
					<p class="btnsel">
						<button class="btn btn-small btn-primary"
							onclick="show_writtenLog();" type="button">SELECT</button>
					</p>
					</form>
